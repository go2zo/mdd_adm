...
public class UMLDiagramHelper implements IUMLDiagramHelper {
	...
	private String getKindToString(UMLDiagramKind kind) {
		if (UMLDiagramKind.SEQUENCE.equals(kind)) {
	...
	public Diagram createDiagram(Namespace container, UMLDiagramKind kind) {
		Diagram diagram = ViewService.createDiagram(container,
				getKindToString(kind), PreferencesHint.USE_DEFAULTS);
		return diagram;
	}
	...
	public Diagram createDiagram(Namespace container, UMLDiagramKind kind,
			Element context) {
		Diagram diagram = ViewService.createDiagram(context,
				getKindToString(kind), PreferencesHint.USE_DEFAULTS);
